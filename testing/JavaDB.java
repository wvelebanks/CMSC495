...
public class JavaDB {
    ...
    // hashTimesheet takes in a string and creates a one-way hash using the hmacSHA256 hashing algorithm.
    ...
    // Helper method to verify that the hash being generated by the hashTimesheet function works properly.
    ...
    // Loads a keypair from the specified keystore, returns the keypair for furhter use.
    // TODO: provide variables for the path to the keystore, the password, and the alias.  These should be set in some configuration file when
    // first creating a user account.
    ...
    // Takes input from loadKey and gets the keypair from the keystore
