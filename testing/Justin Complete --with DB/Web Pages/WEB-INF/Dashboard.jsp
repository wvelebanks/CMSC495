        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <p class="navbar-text navbar-right">
                    ...
                    </font> <a href="Logout.jsp" name="Logout" class="navbar-link"><small><font
                                                ...
                                                <div class="container-fluid">
                                                    <form class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input class="form-control" name="First" value="${First}" type="text" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-3 control-label">Last name:</label>
                                                            <div class="col-lg-8">
                                                                <input class="form-control" name="Last" value="${Last}" type="text" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-3 control-label">Employee ID:</label>
                                                            <div class="col-lg-8">
                                                                <input class="form-control" name=EmployeeID" value="${EmployeeID}" type="text" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-3 control-label">SSN (Last 4):</label>
                                                            <div class="col-lg-8">
                                                                <input class="form-control" name="Ssn" value="${Ssn}" type="text" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input class="form-control" name="Address" value="${Address}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-lg-3 control-label">City:</label>
                                                            <div class="col-lg-8">
                                                                <input class="form-control" name="City" value="${City}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <div class="ui-select">
                                                                    <select select id="states" name="States" class="form-control">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <input class="form-control" name=ZipCode" value="${ZipCode}" type="text">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label">Username:</label>
                                                            <div class="col-md-8">
                                                                <input class="form-control" name="Username" value="${Username}" type="text" disabled>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input class="form-control" name="ConfirmPassword" value="${ConfirmPassword}" type="password">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-3 control-label"></label>
                                                            <div class="col-md-8">
                                                                <input class="btn btn-primary" name="SaveChanges" value="Save Changes"
                                                                       type="button"> <span></span> <input
                                                                        class="btn btn-default" name="CancelChanges" value="Cancel" type="reset">
                                                                        </div>
                                                                        </div>
                                                                        </form>
                                                                        </div>
                                                                            ...
                                                                            <div class="container">
                                                                                ...
                                                                                <div class="row">
                                                                                            ...
                                                                                            <div class="table">
                                                                                                <table class="table table-striped">
                                                                                                    ...
                                                                                                    <c:if test="${newEntry eq true}">
                                                                                                        ...
                                                                                                        <td><button type="button" class="btn btn-success" <!--should be button type="submit" and then call from servlet-->
                                                                                    ...
                                                                                    <div class="container">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-md-3">
                                                                                                <button type="submit"  name="SubmitTimesheet" class="btn btn-primary btn-lg btn-block"
                                                                                            ...
                                                                                            <div class="col-md-4">
                                                                                                ...
                                                                                                <div class="col-md-5">
                                                                                                    <input class="form-control" name="SubmittedBool" value="${SubmittedBool}" type="text"
                                                                                                           disabled>
                                                                                                </div>
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col-md-4 ">
                                                                                                ...
                                                                                                <div class="col-md-5">
                                                                                                    <input class="form-control" name="ApprovalBool" value="${ApprovalBool}" type="text" disabled>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            ...
                                                                                            <div class="panel panel-default">
                                                                                                ...
                                                                                                <div class="col-lg-8">
                                                                                                    <input class="form-control" name="SelectedFName" value="${SelectedFName}" type="text" disabled>
                                                                                                </div>
                                                                                                <br></br> <label class="col-lg-3 control-label">L. Name:</label>
                                                                                                <div class="col-lg-8">
                                                                                                    <input class="form-control" name="SelectedLName" value="${SelectedLName}" type="text" disabled>
                                                                                                </div>
                                                                                                <br></br> <label class="col-lg-3 control-label">E. ID:</label>
                                                                                                <div class="col-lg-8">
                                                                                                    <input class="form-control" name="SelectedEID" value="${SelectedEID}" type="text" disabled>
                                                                                                </div>
                                                                                                <br></br> <label class="col-lg-3 control-label">Status:</label>
                                                                                                <div class="col-lg-8">
                                                                                                    <input class="form-control" name="Status" value="${Status}" type="text" disabled>
                                                                                                </div>
                                                                                                <br></br> <br></br>
                                                                                            </div>

                                                                                            <div class="col-md-12 text-center">
                                                                                                <button type="button" name="ViewTimesheet" class="btn btn-primary btn-lg btn-block"
                                                                                                        style="margin-bottom: 5px;">View Timesheet</button>
                                                                                            </div>
                                                                                            <br></br>
                                                                                            <div class="col-md-12 text-center">
                                                                                                <button type="button" name="ApproveTimesheet" class="btn btn-success btn-lg btn-block"
                                                                                                        style="margin-bottom: 5px;">Approve Timesheet</button>
                                                                                            </div>
                                                                                            <br></br>
                                                                                            <div class="col-md-12 text-center">
                                                                                                <button type="button" name="RejectTimesheet" class="btn btn-danger btn-lg btn-block">Reject
                                                                                                    Timesheet</button>
                                                                                            </div>
