...
CREATE TABLE `usertable` (
  ...
  `EmployeeID` int(5) NOT NULL,
  `UserPublicKey` varbinary(294) DEFAULT NULL,
  PRIMARY KEY (`UserID`),
...
INSERT INTO `usertable` VALUES (1,'admin','SHA2(\'ETMS@dmin123\',256),1)',1,NULL),(2,'jjames','kdfgjoi',2,NULL),(3,'nsmith','993urw',3,NULL),(4,'wjohnson','99fjh23',4,NULL),(5,'iflores','98kjrtdf',5,NULL),(6,'akramer','sfksop',6,NULL);
...
-- Dump completed on 2017-04-28 19:46:08
